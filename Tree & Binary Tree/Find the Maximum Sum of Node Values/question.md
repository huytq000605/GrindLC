# 3068. Find the Maximum Sum of Node Values<br> Hard
...
<img alt="" src="./assets/image0.png" style="width: 300px; height: 277px;padding: 10px; background: #fff; border-radius: .5rem;" />
<pre>
...
<img alt="" src="./assets/image1.png" style="padding: 10px; background: rgb(255, 255, 255); border-radius: 0.5rem; width: 300px; height: 239px;" />
<pre>
...
<img alt="" src="./assets/image2.png" style="width: 600px; height: 233px;padding: 10px; background: #fff; border-radius: .5rem;" />
<pre>
