...
# 2920. Maximum Points After Collecting Coins From All Nodes<br> Hard
...
<img alt="" src="./assets/image1.png" style="width: 60px; height: 316px; padding: 10px; background: rgb(255, 255, 255); border-radius: 0.5rem;" />
<pre>
...
<strong class="example"> <img alt="" src="./assets/image2.png" style="width: 140px; height: 147px; padding: 10px; background: #fff; border-radius: .5rem;" /></strong>
