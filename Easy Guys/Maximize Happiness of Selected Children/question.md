# 3075. Maximize Happiness of Selected Children<br> Medium
...
Hint 1
<details>Since all the unselected numbers are decreasing at the same rate, we should greedily select <code>k</code> largest values.</details>
Hint 2
<details>The <code>i<sup>th</code> largest number (<code>i = 1, 2, 3,…k</code>) should decrease by <code>(i - 1)</code> when it is picked.</details>
Hint 3
<details>Add <code>0</code> if the decreased value is negative.</details>
</details>