...
# 3001. Minimum Moves to Capture The Queen<br> Medium
...
<img alt="" src="./assets/image1.png" style="width: 600px; height: 600px; padding: 10px; background: #fff; border-radius: .5rem;" />
<pre>
...
<img alt="" src="./assets/image2.png" style="width: 600px; height: 600px;padding: 10px; background: #fff; border-radius: .5rem;" />
<pre>
