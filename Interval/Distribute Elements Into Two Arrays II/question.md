# 3072. Distribute Elements Into Two Arrays II<br> Hard
...
Hint 1
<details>- `We need a data structure that counts the number of integers greater than a given value <code>x</code> and supports insertion.`</details>
Hint 2
<details>- `Use Segment Tree or Binary Indexed Tree by compressing the numbers to the range <code>[1,n]</code>.`</details>
</details>