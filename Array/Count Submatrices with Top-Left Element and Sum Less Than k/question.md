# 3070. Count Submatrices with Top-Left Element and Sum Less Than k<br> Medium
...
<img alt="" src="./assets/image0.png" style="padding: 10px; background: #fff; border-radius: .5rem;" />
<pre>
...
<img alt="" src="./assets/image1.png" style="padding: 10px; background: #fff; border-radius: .5rem;" />
<pre>
