...
# 2289. Steps to Make Array Non-decreasing<br> Medium
...
For each element, we need to find the number of rounds it will take for it to be removed. The answer is the maximum number of rounds for all elements.
</details>
...
We can find the closest strictly greater element for each element of the array in linear time with a monotonic stack.
</details>